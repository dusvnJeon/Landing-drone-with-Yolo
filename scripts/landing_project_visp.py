    ...
    while not rospy.is_shutdown():
        ...
        if (target_detected.Xc == 0.0 and target_detected.Yc == 0.0 and 
            ...
            if not target_reached:
                ...
                error_x = target_detected.Xc
                error_y = target_detected.Yc
                ...
                if abs(error_x) < 0.01 and abs(error_y) < 0.01:
                    ...
                    control_msg.velocity.x = - (error_y * 1)  # y축 오차를 x축 속도로 변환
                    control_msg.velocity.y = - (error_x * 1)  # x축 오차를 y축 속도로 변환
